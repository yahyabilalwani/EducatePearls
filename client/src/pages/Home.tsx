    ...
    <div className="min-h-screen">
      ...
      <section className="hero-gradient relative min-h-screen flex items-center overflow-hidden">
        <div className="absolute inset-0 opacity-30">
          ...
          <div className="absolute top-40 right-10 w-72 h-72 bg-emerald-300 rounded-full mix-blend-multiply filter blur-3xl animate-pulse animation-delay-2000"></div>
          <div className="absolute bottom-0 left-1/2 w-96 h-96 bg-green-200 rounded-full mix-blend-multiply filter blur-3xl animate-pulse animation-delay-4000"></div>
        </div>
      ...
      <section className="section-padding bg-white">
        <div className="container-max">
          <div className="max-w-4xl mx-auto text-center space-y-8">
            ...
            <div className="bg-gradient-to-r from-green-50 to-emerald-50 p-8 rounded-2xl border border-green-100/50">
      ...
      {/* Our Vision Section */}
      <section className="py-20 lg:py-28 bg-gradient-to-r from-green-50 to-emerald-50">
        <div className="container-max">
        ...
        <div className="container-max">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {whatWeDo.map((item, idx) => (
              <div key={idx} className="glass-card p-8 rounded-2xl hover:shadow-lg transition-all duration-300 border border-green-100/30">
                <div className="flex items-start mb-4">
                  <div className="flex-shrink-0 h-10 w-10 rounded-full bg-gradient-to-br from-green-600 to-green-700 flex items-center justify-center text-white font-bold">
                    {item.number}
                  </div>
            ...
            {solutions.map((solution, idx) => (
              <div key={idx} className="glass-card p-8 rounded-2xl hover:shadow-lg transition-all duration-300 border border-green-100/30">
                <div className="flex items-center mb-6">
                  <div className="p-3 bg-gradient-to-br from-green-600 to-green-700 rounded-lg text-white">
                    {solution.icon}
                  </div>
        ...
        <div className="container-max">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              <div key={idx} className="p-8 rounded-2xl bg-white border border-green-100/50 hover:shadow-lg transition-all duration-300 text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            {roadmap.map((item, idx) => (
              <div key={idx} className="relative">
                <div className="glass-card p-6 rounded-2xl hover:shadow-lg transition-all duration-300 border border-green-100/30 text-center">
                  <h3 className="text-xl font-bold text-green-600 mb-2">{item.phase}</h3>
            ...
            {getInvolvedOptions.map((option, idx) => (
              <div key={idx} className="glass-card p-8 rounded-2xl hover:shadow-lg transition-all duration-300 border border-green-100/30">
                <div className="flex justify-center mb-6">
                  <div className="p-4 bg-gradient-to-br from-green-600 to-green-700 rounded-lg text-white">
                    {option.icon}
                  </div>
                </div>
      ...
      <section className="py-20 lg:py-28 bg-gradient-to-b from-green-50 to-white">
        <div className="container-max">
          ...
          <div className="max-w-2xl mx-auto text-center space-y-6">
            <div className="glass-card p-8 rounded-2xl border border-green-100/30">
              ...
              <p className="text-lg text-gray-600 mb-3">📧 <Link to="/contact" className="text-green-600 hover:text-green-700 font-semibold">[Your Email]</Link></p>
              <p className="text-lg text-gray-600">📞 <Link to="/contact" className="text-green-600 hover:text-green-700 font-semibold">[Your Phone Number]</Link></p>
            </div>
          </div>
        </div>
      </section>
      ...
      {/* Footer CTA */}
      <section className="py-20 lg:py-28 bg-gradient-to-r from-green-600 via-green-700 to-green-800 relative overflow-hidden">
        <div className="absolute inset-0 opacity-20">
          <div className="absolute top-0 left-10 w-96 h-96 bg-white rounded-full mix-blend-screen filter blur-3xl"></div>
          <div className="absolute bottom-0 right-10 w-96 h-96 bg-emerald-200 rounded-full mix-blend-screen filter blur-3xl"></div>
        </div>
        <div className="container-max text-center relative z-10">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link to="/donate" className="inline-flex items-center justify-center bg-white text-green-600 hover:bg-green-50 font-bold py-4 px-8 rounded-full transition-all duration-300 transform hover:scale-105 shadow-lg text-lg">
              Get Involved
            </Link>
